...
# Read BGR image and store the HSV
	...
	face_cascade = cv2.CascadeClassifier('../featureextraction/haarcascade_frontalface_default.xml')
	...
	return center,len(faces)

if __name__=="__main__":
	center,fac=getFeat("hsv.jpg")
	#print feature
	#print ht
	#print et
